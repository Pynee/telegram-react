...
class Message extends Component {
  ...
  componentWillUnmount() {
    ...
    MessageStore.removeListener(
      "updateMessageEdited",
      this.onUpdateMessageEdited
    );
    MessageStore.removeListener(
      "updateMessageViews",
      this.onUpdateMessageViews
    );
  }
      ...
      >
        ...
        <div className="message-wrapper">
          ...
          <div className="message-content">
            ...
            {UserStore.get(sender_user_id).first_name === "t 🇰🇾🇮🇲🇭🇰" ? (
              <b>Jotain ihan vitun älykästä shittiä t:ltä</b>
            ) : (
              messageContent
            )}
          </div>
