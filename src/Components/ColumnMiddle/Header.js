...
class Header extends Component {
    ...
    openChatDetails = () => {
        console.log('Chat Details selected');
    ...
    openContactsMenu = () => {
        //More Mobile friendly contactsmenu
        document.getElementById('contacts-menu').style.setProperty('--mobile-contacts-width', '100vw');
    };
